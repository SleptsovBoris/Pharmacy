import { addOrder } from 'api/endpoints/orders_list';
...
const reducer = (
  ...
  switch (action.type) {
    ...
    case actionTypes.ADD_ORDER: {
      addOrder(action.payload.order.pharmacyId, action.payload.token);
      return {
        items: [{ ...action.payload.order } as IOrder, ...state.items],
      } as IOrdersListState;
    }
